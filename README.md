...
<table cellspacing="1" bgcolor="">
  ...
  <tr style="text-align: left; vertical-align: middle;" bgcolor="#e4e4ed">
    ...
    <td style="color:#141414">13/03/2024 Max: 22:00<br>Se creará el canal taller 1 con un archivo de google sheets donde se debe colocar la dirección del repo, si éste tiene un commit posterior al corte, se toma como referencia el mas cercano a la fecha establecida.</td>
	</tr>
  <tr style="text-align: left; vertical-align: middle;" bgcolor="#e4e4ed">
